---
name: web-researcher
description: "Use this agent when you need to gather information from the web to inform product development decisions, research third-party services, compare technologies, investigate APIs, or find solutions to technical problems. This agent excels at synthesizing information from multiple sources into actionable insights.  Writes research findings to files/research_notes for later use by report writers. Ideal for complex research tasks\\n\\nExamples:\\n\\n<example>\\nContext: The user is evaluating payment providers for their application.\\nuser: \"What are the best alternatives to Stripe for payment processing?\"\\nassistant: \"I'll use the web-researcher agent to investigate payment processing alternatives and compare them.\"\\n<Task tool call to web-researcher agent>\\n</example>\\n\\n<example>\\nContext: The user encounters an unfamiliar error during development.\\nuser: \"I'm getting a CORS error when trying to connect to my Supabase functions from Cloudflare Workers\"\\nassistant: \"Let me use the web-researcher agent to research this specific CORS issue and find solutions.\"\\n<Task tool call to web-researcher agent>\\n</example>\\n\\n<example>\\nContext: The user needs to implement a new feature and wants to understand best practices.\\nuser: \"How should we implement real-time updates for our list rankings?\"\\nassistant: \".\"\\n<Task tool call to web-researcher agent>\\n</example>"
model: opus
color: cyan
---
